...
| 2026-07-21 | [Plan — Model lifecycle hooks as first-class knowledge-graph nodes](2026-07-21-plan-model-lifecycle-hooks-as-first-class-knowledge-graph-no.md) | implemented | — | — |

Totals: 5 implemented (5 plans).
